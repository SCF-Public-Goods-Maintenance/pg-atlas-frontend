import { Settings as SettingsIcon, Sun, Moon, Monitor, Hash, Scale } from 'lucide-react'
...
export default function Settings() {
  ...
  const [numberFormat, setNumberFormat] = useState<'full' | 'abbreviated'>('full')
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:bg-white/5 dark:border-white/15">
        <div className="flex items-center gap-2 mb-4">
          <SettingsIcon className="h-4 w-4 text-primary-500" aria-hidden="true" />
          <h3 className="text-sm font-semibold text-surface-dark dark:text-white">Appearance</h3>
        </div>

        <div>
          <label className="text-xs font-medium text-surface-dark/60 dark:text-white/50">Theme</label>
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:bg-white/5 dark:border-white/15">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-surface-dark dark:text-white">Display</h3>
        </div>

        <div>
          <label className="text-xs font-medium text-surface-dark/60 dark:text-white/50">Number format</label>
          <div className="mt-2 flex gap-2">
            {[
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:bg-white/5 dark:border-white/15">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-surface-dark dark:text-white">About</h3>
        </div>

        <div className="space-y-2.5 text-sm">
          <div className="flex justify-between text-surface-dark/70 dark:text-white/60">
            <span>Version</span>
            <span className="font-mono text-xs text-surface-dark dark:text-white">0.0.0</span>
          </div>
          <div className="flex justify-between text-surface-dark/70 dark:text-white/60">
            <span>License</span>
            <span className="text-xs text-surface-dark dark:text-white">MPL-2.0</span>
          </div>
          <div className="flex justify-between text-surface-dark/70 dark:text-white/60">
            <span>Data refresh</span>
            <span className="text-xs text-surface-dark/50 dark:text-white/40">Mock data</span>
          </div>
        </div>
      </section>
    </div>
